...
#pragma config(Motor,  port4,           llLift,        tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port9,           ltLift,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port10,          lmLift,        tmotorVex393_HBridge, openLoop, reversed, encoderPort, None)
...
#include "ControllerFunctions.c"                  //this is the line that links the functions library into the other code
#include "AutonomousFunctionsRename.c"
#include "Selection.c"
